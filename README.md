...
> Planning stack → Red phase → Bead-driven implementation → Green phase → Critical review → Queue triage. [Run it yourself](docs/demos/helix-quickstart/) · [asciinema](https://asciinema.org/a/tmz0Uol2ZQukZWtS).
